...
```console
docker build --build-arg INSTALL_KIT=Transfer_CFT_3.6_SP2_linux-x86-64_BN13165000.zip -t cft/cft:3.6-SP2 .
```
...
```console
docker build --build-arg URL_BASE=https://network.package.location/ -t cft/cft:3.6-SP2 .
```
